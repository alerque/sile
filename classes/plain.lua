...
function class:registerCommands ()
   ...
   self:registerCommand("title", function (options, content)
      ...
      SILE.call("center", {}, function ()
         SILE.call("plain:titlefont", {}, content)
      end)
      SILE.call("bigskip")
   end, "Output a document title")

   self:registerCommand("subtitle", function (options, content)
      SILE.call("smallskip")
      SILE.call("center", {}, function ()
         SILE.call("plain:subtitlefont", {}, content)
      end)
      SILE.call("medskip")
   end, "Output a document subtitle")

   self:registerCommand("author", function (options, content)
      SILE.call("medskip")
      SILE.call("center", {}, function ()
         SILE.call("plain:authorfont", {}, content)
      end)
      SILE.call("medskip")
   end, "Output a document author")

   self:registerCommand("rights", function (options, content)
      SILE.call("medskip")
      SILE.call("center", {}, function ()
         SILE.call("plain:rightsfont", {}, content)
      end)
      SILE.call("medskip")
   end, "Output a document rights")

   self:registerCommand("date", function (options, content)
      SILE.call("medskip")
      SILE.call("center", {}, function ()
         SILE.call("plain:datefont", {}, content)
      end)
      SILE.call("medskip")
   end, "Output a document date")
   ...
   self:registerCommand("plain:titlefont", function (_, content)
      SILE.call("font", { weight = 800, size = "2.2em" }, content)
   end)

   self:registerCommand("plain:subtitlefont", function (_, content)
      SILE.call("font", { size = "1.4em" }, content)
   end)

   self:registerCommand("plain:authorfont", function (_, content)
      SILE.call("font", { style = "Italic", size = "1.1em" }, content)
   end)

   self:registerCommand("plain:rightsfont", function (_, content)
      SILE.call("font", { size = "1em" }, content)
   end)

   self:registerCommand("plain:datefont", function (_, content)
      SILE.call("font", { size = "1em" }, content)
   end)
